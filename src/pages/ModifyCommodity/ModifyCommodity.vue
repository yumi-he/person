  ...
  <div class="release-wrap">
    <div class="release-head-wrap">
      ...
      <div class="release-head clearfix">
        ...
        <div class="release-head-title">修改</div>
      </div>
    </div>
    ...
    <div class="release-content-wrap">
      ...
      <div class="release-content-upload-wrap">
        ...
        <div class="release-condition-wrap clearfix" @click="getCondition">
          <span>全新</span>
          <div class="release-condition-choose" :class="{active:ruleForm.condition==1}" v-model="condition">
  ...
  export default {
    ...
    methods:{
      submitRelease(){
        ...
        marketPostReq('/goods/editGoods',_this.ruleForm).then(res=>{
          ...
          if(errcode == 0){
            ...
            // let isSubmitHint = _this.isSubmitHint;
            setTimeout(function () {
      ...
      getCondition(){
        ...
        if(this.ruleForm.condition == 0){
          this.ruleForm.condition = 1;
        } else{
          this.ruleForm.condition = 0;
        }
      ...
      getChangeData(){
        ...
        for(var i=0;i<this.$route.query.data.images.length;i++){
          var images = {url:this.$route.query.data.images[i]}
          this.fileList2.push(images)
        }
        this.ruleForm.cover = this.$route.query.data.cover;
        this.ruleForm.images = this.$route.query.data.images;
        // this.fileList2 = this.$route.query.data.images;
        this.ruleForm.description = this.$route.query.data.description;
        this.ruleForm.condition = this.$route.query.data.condition;
        this.ruleForm.price = this.$route.query.data.price;
        this.ruleForm.wechat = this.$route.query.data.wechat;
        this.ruleForm.category_id = this.$route.query.data.category_id;
        this.ruleForm.goods_id = this.$route.query.data.goods_id;
        this.classificationValue = this.$route.query.data.category_name;
